...
import { X, BarChart3, ShoppingCart, Palette, CheckCircle2, Landmark, Activity, ShoppingBag } from "lucide-react";
...
import healthAiImg from "@/assets/healthcare.png"; // Fixed your typo from "/rc/assets/" to "@/assets/"
...
const projects = [
  ...
  {
    title: "Artisan Direct E-Commerce",
    icon: ShoppingBag,
    summary: "Full-stack platform for local artisans",
    image: ecommerceImg,
    description: "A specialized e-commerce solution featuring secure checkout, artisan profiles, and real-time order tracking.",
    highlights: ["JWT-based Authentication", "Stripe API Integration", "Responsive Dashboard", "Optimized Query Performance"],
  ...
  },
  {
    ...
    technologies: ["Python", "Logistic Regression", "Power BI", "Pandas", "Scikit-Learn"],
  },
  {
